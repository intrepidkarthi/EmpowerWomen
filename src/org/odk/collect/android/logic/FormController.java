    	...
    	if (currentPromptIsQuestion()) {
            ...
            while (it.hasNext()) {
                ...
                if (getEvent(index) == FormEntryController.EVENT_QUESTION) {
                	...
                	//System.out.println("save to disk task "+answer.getDisplayText()+"  "+answer.getValue());
	...
	private class GetRestAPIResponse extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				String getURL = "http://transliteration.reverie.co.in/api/processString?lang="+Collect.getInstance().language_selection+"&type=5&inString="+params[0];
