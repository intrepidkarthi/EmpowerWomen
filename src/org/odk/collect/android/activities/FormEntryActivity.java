...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	private String currLanguage = "eng";
	...
	private SharedPreferences.Editor mAdminPreferencesEditor;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdminPreferencesEditor = mAdminPreferences.edit();
	...
	protected void onActivityResult(int requestCode, int resultCode,
		...
		case EX_STRING_CAPTURE:
			...
			//Toast.makeText(getApplicationContext(), "Text "+sv, Toast.LENGTH_SHORT).show();
				...
				.setSingleChoiceItems(languages, selected,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								System.out.println("languages selection "+languages[whichButton]);
								
								if(languages[whichButton].equals("eng"))
								{
									mAdminPreferencesEditor.putInt("lang", 0);
									currLanguage = "english";
								}
								if(languages[whichButton].equals("hin"))
								{
									mAdminPreferencesEditor.putInt("lang", 1);
									
									currLanguage = "hindi";
									
									//InputMethodManager im = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
									//  if(im != null)  im.toggleSoftInput(0, InputMethodManager.HIDE_IMPLICIT_ONLY);
...
//							        Locale myLocale = new Locale("hi_IN"); 
//							        Resources res = getResources(); 
//							        DisplayMetrics dm = res.getDisplayMetrics(); 
//							        Configuration conf = res.getConfiguration(); 
//							        conf.locale = myLocale; 
//							        res.updateConfiguration(conf, dm); 
//							       // Intent refresh = new Intent(FormEntryActivity.this, FormEntryActivity.class); 
...
//							        imm2.toggleSoftInput(0, InputMethodManager.HIDE_IMPLICIT_ONLY);
								...
								if(languages[whichButton].equals("tam"))
								{
									mAdminPreferencesEditor.putInt("lang", 2);
									currLanguage = "tamil";
								}
								
								mAdminPreferencesEditor.commit();
								
								//new GetRestAPIResponse().execute(currLanguage, ); 
								
								//System.out.println("languages selection2 "+mAdminPreferences.getInt("lang", 10));
								...
								Collect.getInstance().language_selection = languages[whichButton];
	...
	private class GetRestAPIResponse extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			//	System.out.println("Calling API");
				...
				String getURL = "http://transliteration.reverie.co.in/api/processString?lang="+params[0]+"&type=5&inString="+params[1];
				...
				Collect.language_selection = "name_response";
